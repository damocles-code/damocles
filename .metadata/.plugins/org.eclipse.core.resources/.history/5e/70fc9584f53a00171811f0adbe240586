...
contains
    ...
    subroutine read_input()
        ...
        if ((lg_mcmc .and. i_mcmc==1) .or. (.not. lg_mcmc)) then
        ...
        !replace variables with mcmc sampled variables if using mcmc iteration
        if (lg_mcmc) call mcmc_sample()
