...
!        print*, 'vmax',dust_geometry%v_max,'R_rat',dust_geometry%r_ratio,'rho',dust_geometry%rho_power,'mdust',dust%mass, &
!        & 'a',dust%species(1)%amin,'ff',dust_geometry%ff, 'cell size',mothergrid%n_cells(1)
